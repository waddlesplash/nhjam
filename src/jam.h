...
#if !defined(OS_BSDI) && !defined(OS_FREEBSD) && !defined(OS_NEXT) &&          \
	!defined(OS_MACHTEN) && !defined(OS_MACOSX) && !defined(OS_RHAPSODY) &&    \
	!defined(OS_MVS)
#include <malloc.h>
#endif
...
#if defined(_i386_) || defined(__i386__) || defined(__amd64__) ||              \
	defined(_M_IX86)
